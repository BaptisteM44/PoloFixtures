        ...
        <div className="map-side-panel">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                <FilterBtn active={format === ""} onClick={() => { setFormat(""); setSelectedTournament(null); }}>All</FilterBtn>
                {FORMATS.map((f) => (
          ...
          {selectedTournament ? (
            ...
            <div className="panel" style={{ padding: "20px", color: "var(--text-muted)", fontSize: 13, textAlign: "center" }}>
              <p style={{ margin: 0 }}>Click a marker to see tournament details.</p>
              <p style={{ margin: "8px 0 0", fontSize: 12 }}>
                <span style={{ color: "#ef4444" }}>●</span> Live &nbsp;
                <span style={{ color: "#22c55e" }}>●</span> Reg. open &nbsp;
