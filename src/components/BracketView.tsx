...
export function BracketView({
  ...
  const bracketMatches = matches.filter((m) => m.phase === "BRACKET" || m.phase === "GRAZ_SE" || m.phase === "MTP_DE" || m.phase === "KIOSQUE_SE" || m.phase === "BIG_APPLE_SE" || m.phase === "STAGE" || m.phase === "TOP32" || m.phase === "BOTTOM16");
